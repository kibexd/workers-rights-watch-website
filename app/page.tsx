...
export default function HomePage() {
  ...
  // --- Twitter API fetching logic (commented out for now) ---
  ...
  <div className="container mx-auto px-6">
    ...
    <div className="grid md:grid-cols-3 gap-10">
      ...
      {/* Twitter Feed Section (using embed widget) */}
...
// --- TwitterFeedEmbed component ---
function TwitterFeedEmbed() {
