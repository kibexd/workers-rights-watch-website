                      ...
                      >
                        <Card className="bg-card border-0 overflow-hidden rounded-2xl hover:shadow-xl hover:shadow-teal-500/5 transition-all duration-300 h-full">
                          ...
                          <CardHeader className="pt-6 pb-2">
                            ...
                            <p className="text-sm text-teal-500 text-teal-600">
                              {article.date}
                            </p>
                          </CardHeader>
                          ...
                          <CardFooter>
                            <Dialog>
                              <DialogTrigger asChild>
                                <Button
                                  variant="outline"
                                  className="text-teal-500 border-teal-500 border-teal-600 hover:bg-teal-500 hover:text-black rounded-full"
                                >
                                  Read More
                                </Button>
                              </DialogTrigger>
                                ...
                                <DialogHeader>
                                  ...
                                  <div className="text-muted-foreground">
                                    <div className="flex items-center gap-4 mt-2">
                                      <span className="text-teal-500 text-teal-600">
                                        {article.date}
                                      </span>
                        ...
                        <Dialog>
                          ...
                          <DialogContent className="bg-card border-0 rounded-2xl max-w-5xl p-0">
                            ...
                            <div className="p-6">
                              ...
                              <div className="text-muted-foreground text-sm mt-2 flex items-center">
